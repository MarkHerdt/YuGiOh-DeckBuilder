...
internal static class DirectoryInfoExtensions
{
    ...
    internal static void DeepCopy(this DirectoryInfo sourceDirectory, DirectoryInfo targetDirectory)
    {
    ...
    internal static void DeepCopy(this DirectoryInfo sourceDirectory, DirectoryInfo targetDirectory, params string[] excludePaths)
    {
        Directory.CreateDirectory(targetDirectory.FullName);
