...
/// <param name="PropertyType"><see cref="Enums.PropertyType"/> of this <see cref="Trap"/> card</param>
...
) : ACard(Localized, Endpoint, ImageEndpoint, Passcode, Rarities, Statuses)
{
    ...
    public override CardType CardType { get; } = CardType.Trap;
    /// <summary>
    /// <see cref="Enums.PropertyType"/> of this <see cref="Trap"/> card
    /// </summary>
